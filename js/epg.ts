...
function renderEpgInline(): void {
    var headerEl = document.getElementById('epgInlineHeader');
    var listEl = document.getElementById('epgInlineList');
...
export { renderEpgInline, loadEpgFromUrl, parseXmltv };
