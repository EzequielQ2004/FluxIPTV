...
var translations: Record<string, Record<string, string>> = {
    es: {
        ...
        'modal.about.changelogTitle': 'Novedades',
        'modal.about.changelog120': 'Modal Acerca de, sistema i18n, modo TV, protección PIN, PWA',
        'modal.about.changelog110': 'Reproductor, configuración, extensión de navegador',
        ...
        'ui.noPlaylistsHint': '+ para añadir una lista nueva',
    ...
    en: {
        ...
        'modal.about.changelogTitle': 'Changelog',
        'modal.about.changelog120': 'About modal, i18n system, TV mode, PIN protection, PWA',
        'modal.about.changelog110': 'Player, settings, browser extension',
        ...
        'ui.noPlaylistsHint': '+ to add a new list',
